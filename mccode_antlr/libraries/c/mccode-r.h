...
*   int numipar;
*   struct mcliteralstable_struct mcliteralstable[];
*   int numliterals;
...
#  define MCCODE_STRING " 3.9999-git, git"
#endif
...
#  define MCCODE_VERSION "3.9999-git"
#endif
...
/** Header information for literals-r.c ---------------------------------------------------------------------------- */
...
extern struct literals_table_struct literals_table[];   /* list of component-defined string literals */
extern int    num_literals;                             /* number of component-defined string literals */
